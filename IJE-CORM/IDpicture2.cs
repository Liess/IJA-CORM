...
namespace IJE
{
    public partial class IDpicture2 : Form
    {
        SoundPlayer player;
        private BorrowerInfo _idpic = null;
        public IDpicture2(BorrowerInfo idpic)
        {
            InitializeComponent();
            _idpic = idpic;
        }
        ...
        private void IDpicture2_Load(object sender, EventArgs e)
        {
